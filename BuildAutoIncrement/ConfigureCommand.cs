    ...
    internal sealed class ConfigureCommand : BaseCommand
    {
        ...
        protected override void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (configurationForm.ShowDialog(new WindowAdapter((int)m_devEnvApplicationObject.MainWindow.HWnd)) == DialogResult.OK)
                {
            ...
            {
                ExceptionForm.Show(new WindowAdapter((int)m_devEnvApplicationObject.MainWindow.HWnd), ex, "Error starting Versioning Controlled Build add-in");
            }
        }
    }
}
