...
namespace BuildAutoIncrement
{
    ...
    public class VSSCheckout : SourceSafeCheckout
    {
        ...
        /// </param>
        public VSSCheckout(DTE environment, IServiceProvider package) : base()
        {
        ...
        public override void CheckOut(ProjectInfo[] projectsToCheckOut)
        {
            ...
            if (filesNotCheckedOut.Count > 0)
            {
                ...
                if (!CheckOutFilesThroughShell(filesToCheckOut))
                    if (CheckOutErrorDialog.Show(new WindowAdapter((int)m_environment.MainWindow.HWnd), (string[])filesNotCheckedOut.ToArray(typeof(string))) == DialogResult.No)
