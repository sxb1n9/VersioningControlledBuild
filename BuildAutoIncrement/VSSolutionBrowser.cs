...
namespace BuildAutoIncrement
{
    ...
    public class VSSolutionBrowser : SolutionBrowser, IDisposable
    {
        ...
        */
        ...
        {
            get { Microsoft.VisualStudio.Shell.ThreadHelper.ThrowIfNotOnUIThread(); return Path.GetFileNameWithoutExtension(m_devEnvApplicationObject.Solution.FileName); }
        }
...
#if DEBUG
                    ExceptionForm.Show(new WindowAdapter((int)m_devEnvApplicationObject.MainWindow.HWnd), e, "VCB Error");
#endif
                }
            }
        }
        ...
        private void RecurseSubProjectTree(ProjectItems parentProjectItems, ProjectInfo parentProjectInfo, int level)
        {
            ...
            {
                ExceptionForm.Show(new WindowAdapter((int)m_devEnvApplicationObject.MainWindow.HWnd), e, "Browsing Solution Error");
            }
        }
        ...
        private void PromptForUnsavedDocuments()
        {
            ...
            {
                if (PromptUnsavedDocumentsDialog.Show(new WindowAdapter((int)m_devEnvApplicationObject.MainWindow.HWnd), unsavedDocuments) == System.Windows.Forms.DialogResult.Cancel)
                {
